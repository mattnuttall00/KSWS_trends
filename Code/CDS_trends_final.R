...
# 95% black and white
gsl_plot_95_gr <- plot95Grfun(gsl.dat,gsl.quants,"Silver langur","Ind","Group individual abundance",10500)
...
ltm.quants$Q2.5 <- ltm.quants$Q2.5 * 1000000
ltm.quants$Q7.5 <- ltm.quants$Q7.5 * 1000000
ltm.quants$Q50 <- ltm.quants$Q50 * 1000000
ltm.quants$Q92.5 <- ltm.quants$Q92.5 * 1000000  
ltm.quants$Q97.5 <- ltm.quants$Q97.5 * 1000000
...
ptm.quants$Q2.5 <- ptm.quants$Q2.5 * 1000000
ptm.quants$Q7.5 <- ptm.quants$Q7.5 * 1000000
ptm.quants$Q50 <- ptm.quants$Q50 * 1000000
ptm.quants$Q92.5 <- ptm.quants$Q92.5 * 1000000  
ptm.quants$Q97.5 <- ptm.quants$Q97.5 * 1000000
...
# save (to avoid having to re-run)
write.csv(pig.bs.gams.df, file="pig.bs.gams.df.2.csv")
...
#experiment with remocing bum rows 
...
#To make the same effort so plots make sense 
pig.quants$Q2.5 <- pig.quants$Q2.5 * 1000000
pig.quants$Q7.5 <- pig.quants$Q7.5 * 1000000
pig.quants$Q50 <- pig.quants$Q50 * 1000000
pig.quants$Q92.5 <- pig.quants$Q92.5 * 1000000  
pig.quants$Q97.5 <- pig.quants$Q97.5 * 1000000
...
gpf.quants$Q2.5 <- gpf.quants$Q2.5 * 1000000
gpf.quants$Q7.5 <- gpf.quants$Q7.5 * 1000000
gpf.quants$Q50 <- gpf.quants$Q50 * 1000000
gpf.quants$Q92.5 <- gpf.quants$Q92.5 * 1000000  
gpf.quants$Q97.5 <- gpf.quants$Q97.5 * 1000000
...
red.quants$Q2.5 <- red.quants$Q2.5 * 1000000
red.quants$Q7.5 <- red.quants$Q7.5 * 1000000
red.quants$Q50 <- red.quants$Q50 * 1000000
red.quants$Q92.5 <- red.quants$Q92.5 * 1000000  
red.quants$Q97.5 <- red.quants$Q97.5 * 1000000
...
# first make all the individual plots
ycg.95 <- plot95Grfun4(ycg.dat, ycg.quants,"Gibbon","Ind","Abundance", 3100)
gsl.95 <- plot95Grfun4(gsl.dat, gsl.quants,"Langur","Ind","Abundance", 10450)
ltm.95 <- plot95Grfun4(ltm.dat, ltm.quants,"LT macaque","Ind","Abundance", 8450)
ptm.95 <- plot95Grfun4(ptm.dat, ptm.quants,"PT macaque","Ind","Abundance", 8750)
stm.95 <- stm.95
bsd.95 <- plot95Grfun4(bsd.dat, bsd.quants,"Douc","Ind","Abundance", 50500)
btg.95 <- btg.95
gau.95 <- gau.95
...
stab.p2[[4]] <- stab.p2[[4]] + theme(axis.title.x = element_text(size=17))
stab.p2[[5]] <- stab.p2[[5]] + theme(axis.title.x = element_text(size=17))
stab.p2[[6]] <- stab.p2[[6]] + theme(axis.title.x = element_text(size=17))

# adjust y axis label size
stab.p2[[1]] <- stab.p2[[1]] + theme(axis.title.y = element_text(size=17))
stab.p2[[4]] <- stab.p2[[4]] + theme(axis.title.y = element_text(size=17))

# adjust size of tick mark numbers
stab.p2[[1]] <- stab.p2[[1]] + theme(axis.text = element_text(size=16))
stab.p2[[2]] <- stab.p2[[2]] + theme(axis.text = element_text(size=16))
stab.p2[[3]] <- stab.p2[[3]] + theme(axis.text = element_text(size=16))
stab.p2[[4]] <- stab.p2[[4]] + theme(axis.text = element_text(size=16))
stab.p2[[5]] <- stab.p2[[5]] + theme(axis.text = element_text(size=16))
stab.p2[[6]] <- stab.p2[[6]] + theme(axis.text = element_text(size=16))

# adjust size of plot titles
stab.p2[[1]] <- stab.p2[[1]] + theme(plot.title = element_text(size=16))
stab.p2[[2]] <- stab.p2[[2]] + theme(plot.title = element_text(size=16))
stab.p2[[3]] <- stab.p2[[3]] + theme(plot.title = element_text(size=16))
stab.p2[[4]] <- stab.p2[[4]] + theme(plot.title = element_text(size=16))
stab.p2[[5]] <- stab.p2[[5]] + theme(plot.title = element_text(size=16))
stab.p2[[6]] <- stab.p2[[6]] + theme(plot.title = element_text(size=16))

ggsave("Output/Results/Plots/Trends/trend_plot95_stable_3.png", stab.p2,
...
decr.p2[[3]] <- decr.p2[[3]] + theme(axis.title.x = element_text(size=17))
decr.p2[[4]] <- decr.p2[[4]] + theme(axis.title.x = element_text(size=17))
decr.p2[[5]] <- decr.p2[[5]] + theme(axis.title.x = element_text(size=17))

# adjust y axis label size for 1 and 4
decr.p2[[1]] <- decr.p2[[1]] + theme(axis.title.y = element_text(size=17))
decr.p2[[4]] <- decr.p2[[4]] + theme(axis.title.y = element_text(size=17))

# adjust size of tick mark numbers
decr.p2[[1]] <- decr.p2[[1]] + theme(axis.text = element_text(size=16))
decr.p2[[2]] <- decr.p2[[2]] + theme(axis.text = element_text(size=16))
decr.p2[[3]] <- decr.p2[[3]] + theme(axis.text = element_text(size=16))
decr.p2[[4]] <- decr.p2[[4]] + theme(axis.text = element_text(size=16))
decr.p2[[5]] <- decr.p2[[5]] + theme(axis.text = element_text(size=16))

# adjust size of plot titles
decr.p2[[1]] <- decr.p2[[1]] + theme(plot.title = element_text(size=16))
decr.p2[[2]] <- decr.p2[[2]] + theme(plot.title = element_text(size=16))
decr.p2[[3]] <- decr.p2[[3]] + theme(plot.title = element_text(size=16))
decr.p2[[4]] <- decr.p2[[4]] + theme(plot.title = element_text(size=16))
decr.p2[[5]] <- decr.p2[[5]] + theme(plot.title = element_text(size=16))


ggsave("Output/Results/Plots/Trends/trend_plot95_decrease_3.png", decr.p2,
       width = 30, height = 20, units = "cm", dpi = 600)
